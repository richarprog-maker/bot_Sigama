...
const conversationFlows = {
  SALUDO_INICIAL: {
    ...
    name: 'SALUDO INICIAL',
    instructions: [
      'Si el cliente saluda, preséntate como Sigma AI tal cual como esta no conviertasa minuscula la IA, y que eres asistente  de SIGMA luego di en que puedes ayudar y pregunta su nombre.',
