  ...
  SALUDO_INICIAL: {
    ...
    CONSULTA_OT: {
      ...
      instructions: [
        ...
        'si ya ingreso ot con placa o numero es especifica, por ejemplo Quiero consultar la OT 23277<> esto es una especifica y cumple todo y de la misma forma con la placa por ejemplo: Quiero consultar la información de la placa BWL026',
